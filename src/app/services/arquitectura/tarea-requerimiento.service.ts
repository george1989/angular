...
const baseUrl = environment.urlBack + '/api/requerimiento/tarea';

@Injectable({
  providedIn: 'root'
})
export class TareaRequerimientoService {
  ...
  findByidHito(cat: any): Observable<ERespuesta> {
    return this.http.get<ERespuesta>(`${baseUrl}/hito/${cat}`);
  }
