...
const baseUrl = environment.urlBack + '/api/matriz-documentacion';

@Injectable({
  providedIn: 'root'
})
export class DocumentacionArquitecturaService {
  ...
  filter(data: any): Observable<ERespuesta> {
    return this.http.post<ERespuesta>(`${baseUrl}/filtro`, data);
  }
