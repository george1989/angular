...
const baseUrl = environment.urlBack + '/api/infraestructura-componente';

@Injectable({
  providedIn: 'root'
})
export class InfraestructuraComponenteService {
  ...
  findByidCom(com: any): Observable<ERespuesta> {
    return this.http.get<ERespuesta>(`${baseUrl}/componente/${com}`);
  }
}
